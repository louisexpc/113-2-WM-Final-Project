...
def get_product_name_from_product_type(product_type_dict: dict[str, list[str]], customers_df: pd.DataFrame, model, tokenizer) -> dict[str, list[str]]:
    ...
    for user_id, product_types in product_type_dict.items():
        ...
        for product_type in product_types:
            ...
            Customer context:
            - Age: {customers_df["age"]}
            - Fashion magazine subscription: {customers_df["fashion_news_frequency"]}
            - Club status: {customers_df["club_member_status"]}
