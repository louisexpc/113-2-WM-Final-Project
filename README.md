...
> 圖表：  
> ![](./eda/outputs/fig_cat_product_type_name.png)  
> ![](./eda/outputs/fig_cat_product_group_name.png)

## 多維交叉分析

### 3.1 產品群組 × Index 熱力圖  
![](./eda/outputs/fig_heat_pg_ix.png)
...
### 3.2 圖案 × 顏色（前五大圖案）  
![](./eda/outputs/fig_stack_graph_color.png)
...
### 📊 平均價格分布圖  
![](./eda/outputs/fig_price_hist.png)
...
### 🧾 每月總銷售量  
![](./eda/outputs/fig_monthly_sales.png)
...
### 🔝 Top 100 商品月銷量  
![](./eda/outputs/fig_top100_sales_trend.png)

- 隨整體銷售波動而同步變動，顯示熱門商品符合季節性需求。
- 2020 年 4 月出現單月高峰，可能與春夏上新及線上推廣活動有關。

### 🔻 Least 100 商品月銷量  
![](./eda/outputs/fig_least100_sales_trend.png)
...
![](./eda/outputs/fig_top10_sales_heatmap.png)
...
## 2. Session 長度分布  
![](./eda/outputs/fig_session_length_hist.png)
...
## 3. Session 時間跨度分布  
![](./eda/outputs/fig_session_span_days.png)
...
![](./eda/outputs/fig_session_length_vs_price.png)
