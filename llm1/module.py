...
def enrich_user_sessions(tokenizer, model, user_sessions, category_list, total_len, top_k, short_model, prompt_path, mapping_path):
    enriched_sessions = {}
    for uid, items in user_sessions.items():
        ...
        history_str = [article_to_product_type(item, mapping_path) for item in items]
        ...
        # Generate Categories
        raw_output, k = get_categories_from_history(tokenizer, model, history_str, category_list, total_len, prompt_path)
